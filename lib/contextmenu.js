...
module.exports = function (site, book, mainWindow, x, y) {
        ...
        let saveEPUB = function (title) {
            ctxMenu = null
            ctxTpl = null

            getChapters(mainWindow, function (authors, err, data) {
        ...
        site.isLoggedin()
            ...
            .then(title => {
                ...
                // for displaying contextmenu at the final catch below
